...
function makeLattice(dim::Int,  phdim::Int)
    ...
    Phi=0.0
    xyInteraction=0.0*[K1*cos(Phi)^2+K2*sin(Phi)^2 0.0 (K1-K2)*sin(Phi)*cos(Phi)
    0 K0 0
    (K1-K2)*sin(Phi)*cos(Phi) 0 K2*cos(Phi)^2+K1*sin(Phi)^2 ]

    Phi=4pi/3
    xzInteraction=0.0*[K1*cos(Phi)^2+K2*sin(Phi)^2 0.0 (K1-K2)*sin(Phi)*cos(Phi)
    0 K0 0
    (K1-K2)*sin(Phi)*cos(Phi) 0 K2*cos(Phi)^2+K1*sin(Phi)^2 ]


    Phi=2pi/3
    yzInteraction=0.0*[K1*cos(Phi)^2+K2*sin(Phi)^2 0.0 (K1-K2)*sin(Phi)*cos(Phi)
    0 K0 0
    (K1-K2)*sin(Phi)*cos(Phi) 0 K2*cos(Phi)^2+K1*sin(Phi)^2 ]
